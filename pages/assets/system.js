...
// =============================================================
function initSystem() {
  document.getElementById('healthzBtn').addEventListener('click', () => sysFetch('/healthz', 'GET /healthz'));
  document.getElementById('readyzBtn').addEventListener('click', () => sysFetch('/readyz', 'GET /readyz'));
  document.getElementById('warmupBtn').addEventListener('click', () => sysFetch('/warmup', 'POST /warmup', { method: 'POST' }));
}
